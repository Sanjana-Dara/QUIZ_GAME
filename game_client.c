...
{
	int c_sock;
	char buf1[100]="\0",ques[100];char msg[100]; char name[100];char ack[100]; char succ[100]; char win[100];char ans[5][100];
	...
	gets(name);
		...
		printf("\nANSWER THE FOLLOWING MULTIPLE CHOICE QUESTIONS....SINGLE ANSWER IS ALLOWED[A|B|C|D]\n");
		for(int i=0; i<5;i++)
		{
